...
export namespace BuildIns {
    ...
    export function* buildIn_arith_op( ctx:ContextBase , stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase, f) {
        ...
        if (isVar(arg2)) new Solution.Solution(Solution.SolutionState.QFalse, GTems.atom_false(), {})
    ...
    export function* buildIn_binary_op(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase, f) {
        //arg1 nao rh uma variavel ..bind o argumento para o valor dela ..senao,bind na saida
        let sol_next = new Solution.Solution(Solution.SolutionState.QTrue, GTems.atom_true(), {})
        if (isVar(arg1)) new Solution.Solution(Solution.SolutionState.QFalse, GTems.atom_false(), {})
        if (isVar(arg2)) new Solution.Solution(Solution.SolutionState.QFalse, GTems.atom_false(), {})
    ...
    export function* buildIn_cmp_op(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase, f) {
        //arg1 nao rh uma variavel ..bind o argumento para o valor dela ..senao,bind na saida
        let sol_next = new Solution.Solution(Solution.SolutionState.QTrue, GTems.atom_true(), {})
        if (isVar(arg1)) new Solution.Solution(Solution.SolutionState.QFalse, GTems.atom_false(), {})
        if (isVar(arg2)) new Solution.Solution(Solution.SolutionState.QFalse, GTems.atom_false(), {})
    ...
    export function* buildIn_gte(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase) {
        for (var vv of buildIn_cmp_op(ctx,stk, sol, arg1, arg2, (x1, x2) => { return x1 >= x2 })) yield vv
    }
    export function* buildIn_lte(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase) {
        for (var vv of buildIn_cmp_op(ctx,stk, sol, arg1, arg2, (x1, x2) => { return x1 <= x2 })) yield vv
    }


    export function* buildIn_lt(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase) {
        for (var vv of buildIn_cmp_op(ctx,stk, sol, arg1, arg2, (x1, x2) => { return x1 < x2 })) yield vv
    }

    export function* buildIn_gt(ctx:ContextBase ,stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase) {
        for (var vv of buildIn_cmp_op(ctx,stk, sol, arg1, arg2, (x1, x2) => { return x1 > x2 })) yield vv
    }

    export function* buildIn_mul(ctx:ContextBase ,stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase) {
        for (var vv of buildIn_arith_op(ctx,stk, sol, arg1, arg2, (x1, x2) => { return x1 * x2 })) yield vv
    }

    export function* buildIn_add(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase) {
    ...
    export function* buildIn_minus(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase) {
        for (var vv of buildIn_arith_op(ctx,stk, sol, arg1, arg2, (x1, x2) => { return x1 - x2 })) yield vv
    }
    export function* buildIn_div(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase) {
        for (var vv of buildIn_arith_op(ctx,stk, sol, arg1, arg2, (x1, x2) => { return x1 / x2 })) yield vv
    }

    export function* buildIn_mod(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase) {
        for (var vv of buildIn_arith_op(ctx,stk, sol, arg1, arg2, (x1, x2) => { return x1 % x2 })) yield vv
    }

    export function* buildIn_head(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase) {
        //arg1 nao rh uma variavel ..bind o argumento para o valor dela ..senao,bind na saida
        let sol_next = new Solution.Solution(Solution.SolutionState.QTrue, GTems.atom_true(), {})
        // if (isVar(arg1)) new Solution.Solution(Solution.SolutionState.QFalse, GTems.atom_false(), {})
        if (isVar(arg2)) {
    ...
    export function* buildIn_tail(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase) {
        //arg1 nao rh uma variavel ..bind o argumento para o valor dela ..senao,bind na saida
        let sol_next = new Solution.Solution(Solution.SolutionState.QTrue, GTems.atom_true(), {})
        // if (isVar(arg1)) new Solution.Solution(Solution.SolutionState.QFalse, GTems.atom_false(), {})
        if (isVar(arg2)) {
    ...
    export function* buildIn_atom_string(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase) {
        let sol_next = new Solution.Solution(Solution.SolutionState.QTrue, GTems.atom_true(), {})
    ...
    export function* buildIn_member(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase) {
        let sol_next = new Solution.Solution(Solution.SolutionState.QTrue, GTems.atom_true(), {})
    ...
    export function* buildIn_random_member(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase) {
    ...
    export function* buildIn_nextto(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase, arg3: GTems.GBase) {
        let sol_next = new Solution.Solution(Solution.SolutionState.QTrue, GTems.atom_true(), {})
    ...
    export function* buildIn_append(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase, arg3: GTems.GBase) {
        let sol_next = new Solution.Solution(Solution.SolutionState.QTrue, GTems.atom_true(), {})
    ...
    export function* buildIn_ht(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase, arg3: GTems.GBase) {
        let sol_next = new Solution.Solution(Solution.SolutionState.QTrue, GTems.atom_true(), {})
        ...
        if (arg3 instanceof GTems.Variable)
            if (arg2 instanceof GTems.GList) {
                ...
                for (var v of  buildIn_append(ctx,stk, sol, nlist1, arg2, arg3)) yield v
                return
            }
        return
        throw new Error("invalid arguments")
    ...
    export function* buildIn_maplist(ctx:ContextBase, stk: QueryStack, sol: Solution.Solution, arg1: GTems.GBase, arg2: GTems.GBase) {
        let sol_next = new Solution.Solution(Solution.SolutionState.QTrue, GTems.atom_true(), {})
        if ( isVar(arg1)) {
